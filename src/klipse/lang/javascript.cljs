...
(def opts {:editor-in-mode "javascript"
           ...
           :external-scripts [(codemirror-mode-src "javascript") "https://viebel.github.io/klipse/repo/js/pretty_format.js"]
           :comment-str "//"})
...
(def es2017-opts {:editor-in-mode "javascript"
           :editor-out-mode "javascript"
           :eval-fn eval-es2017
           :external-scripts [(codemirror-mode-src "javascript") "https://viebel.github.io/klipse/repo/js/pretty_format.js" "https://cdnjs.cloudflare.com/ajax/libs/babel-standalone/6.18.1/babel.min.js" "https://viebel.github.io/klipse/repo/js/babel_polyfill.min.js"]
           :comment-str "//"})
